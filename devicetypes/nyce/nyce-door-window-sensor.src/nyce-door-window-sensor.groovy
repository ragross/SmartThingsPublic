  ...
  * 
  *	Extract From File: nyce-device-type-MASTER.groovy v1.0.0 
  * 
  *	File: nyce-door-window-sensor.groovy 
  *	Version: v1.0.1 
 ...
 metadata { 
 	definition (name: "NYCE Door/Window Sensor", namespace: "NYCE", author: "NYCE") { 
 		capability "Battery" 

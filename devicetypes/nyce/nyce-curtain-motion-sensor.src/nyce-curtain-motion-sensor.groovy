 ...
 *
 *	File: nyce-curtain-motion-sensor.groovy
 *	Version: v1.0.0
...
metadata {
	definition (name: "NYCE Curtain Motion Sensor", namespace: "NYCE", author: "NYCE") {
		capability "Battery"
		...
		fingerprint inClusters: "0000,0001,0003,0020,0402,0405,0406,0500", manufacturer: "NYCE", model: "3045"
	}

...
metadata
{
	definition (name: "Roomie Agent", namespace: "roomieremote-agent", author: "Roomie Remote, Inc.")
    {
	...
	tiles
    {
        ...
        {
        	state "default", label: "Roomie", icon: "st.sonos.play-icon", backgroundColor: "#55A7FF"
		}

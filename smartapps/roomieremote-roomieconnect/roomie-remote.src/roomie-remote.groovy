...
definition(
    ...
    description: "Allows you to integrate your Roomie controlled home with SmartThings.",
    category: "My Apps",
...
preferences()
{
	section("Allow Roomie to Monitor and Control These Things...") {
		...
		//input "lockCodes", "capability.lockCodes", title: "Which Lock Code Controllers?", multiple: true, required: false
        //input "pollers", "capability.polling", title: "Which Polling Devices?", multiple: true, required: false
        //input "refreshes", "capability.refresh", title: "Which Refreshable Devices?", multiple: true, required: false
    ...
    section("Allow Roomie to Monitor These Things...") {
        ...
        //input "locationModes", "capability.locationMode", title: "Which Location Monitors?", multiple: true, required: false
        //input "momentaries", "capability.momentary", title: "Which Momentary Switches?", multiple: true, required: false
        //input "signalMeters", "capability.signalStrength", title: "Which Signal Meters?", multiple: true, required: false
        //input "sleepSensors", "capability.sleepSensor", title: "Which Sleep Sensors?", multiple: true, required: false
        //input "threeAxes", "capability.threeAxis", title: "Which Three Axis Devices?", multiple: true, required: false
...
def agentDiscovery(params=[:])
{
    ...
    return dynamicPage(name:"agentDiscovery", title:"Pair with Roomie Agent", nextPage:"", refreshInterval: refreshInterval, install:true, uninstall: true) {
        section("Pair with Roomie Agent")
        {
        	...
        	href(name:"manualAgentEntry",
            	 title:"Manually Configure Roomie Agent",
                 required:false,
...
{
	dynamicPage(name:"manualAgentEntry", title:"Manually Configure Roomie Agent", nextPage:"verifyManualEntry", install:false, uninstall:true) {
    	section("Manually Configure Roomie Agent")
        {
        	paragraph "In the event that Roomie Agent cannot be automatically discovered by your SmartThings hub, you may enter Roomie Agent's IP address here."
...
def verifyManualEntry()
{
    ...
    def manualAgent = [deviceType: "04",
                        ...
                        hub: hubId,
                        verified: true,
                        name: "Roomie Agent $manualIPAddress"]

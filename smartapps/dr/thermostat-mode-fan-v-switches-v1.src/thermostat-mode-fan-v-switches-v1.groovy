 ...
 */
definition(
    name: "Thermostat Mode/Fan:V-Switches v1",
    namespace: "DR",
    author: "DarcRanger",
...
def appTouch(evt) {
	...
	log.info ("ThermoMode-Status: " + thermostat.currentValue("thermostatMode") + "  |Thermostat-State: " + thermostat.currentValue("thermostatOperatingState") + " | Thermofan-Status: " + thermostat.currentValue("thermostatFanMode") + " | ThermoTemp: " + thermostat.currentValue("temperature") + " °F - " +  thermostat.currentValue("humidity")+ "%")
        sendPush("ThermoMode-Status: " + thermostat.currentValue("thermostatMode") + "  |Thermostat-State: " + thermostat.currentValue("thermostatOperatingState") + " | Thermofan-Status: " + thermostat.currentValue("thermostatFanMode") + " | ThermoCurrent: " + thermostat.currentValue("temperature") + " °F - " +  thermostat.currentValue("humidity")+ "%")
    }